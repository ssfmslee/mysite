...
def create_navbar():
    ...
    if current_user.is_authenticated:
        return Navbar("Miss Lee's Site", home_view, posts_view, misc_subgroup, logout_view)
    else:
        return Navbar("Miss Lee's Site", home_view, misc_subgroup, login_view, register_view)
